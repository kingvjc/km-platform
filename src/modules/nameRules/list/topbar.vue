...
<div class="name-search">
    <el-header>
    	...
    	<el-upload
		  ...
		  action="localhost:3000/api/fileUpload"
	...
	<el-row :gutter="20">
	    <el-col :span="4">
	  	    <el-input v-model ="searchQuery.id" placeholder="请输入id" size="small" @change="changeCodeValue(searchQuery)"></el-input>
	    </el-col>
	    <el-col :span="4">
	        <el-input v-model="searchQuery.name" placeholder="请输入名称" size="small"  @change="changeCodeValue(searchQuery)"></el-input>
	    </el-col>
	    <el-col :span="4">
	        <el-input v-model="searchQuery.code" placeholder="请输入字段" size="small"  @change="changeCodeValue(searchQuery)"></el-input>
	    </el-col>
	    <el-col :span="4">
